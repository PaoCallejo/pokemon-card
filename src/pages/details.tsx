                    ...
                    >
                        <div>
                            ...
                            <Typography variant="h5" color="black" sx={{
                                ...
                                <div>
                                    {pokemon.sprites && Object.keys(pokemon.sprites).map((positionImage, index) => (
                                        <img
                                            src={pokemon.sprites[positionImage] && typeof pokemon.sprites[positionImage] == 'string' && pokemon.sprites[positionImage]}/>
